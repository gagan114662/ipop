...
async def get_job(
    ...
    try:
        ...
        return job  # Already a Pydantic model compatible with JobResponse
...
async def retry_job(
    ...
    try:
        ...
        from app.worker.resize_worker import start_resize_job
        await start_resize_job(job_id)
        
        logger.info(f"Job {job_id} retry initiated")
        
        return updated_job  # Already a valid JobResponse
